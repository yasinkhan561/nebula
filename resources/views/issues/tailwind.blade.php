<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">

    <section class="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5">
    <div class="px-4 mx-auto max-w-screen-3xl lg:px-12">
             ...
             <div class="flex items-center flex-1 space-x-4">
              ...
              <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                  ...
                  <div class="inline-block relative w-64">
                        <select name="website" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                        <option value="">Select Website</option>  
                        <option value="foodbuy">Food Buy</option>
                          <option value="devwp">Dev WP</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M14.293 7.293a1 1 0 0 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L10 10.586l3.293-3.293zM5 11a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                            </svg>
                        </div>
                    </div>
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                          ...
                          <th scope="col" class="px-4 py-3">Issue Link</th>
                          <th scope="col" class="px-4 py-3">Description</th>
                          <th scope="col" class="px-4 py-3">Criterion</th>
                          ...
                          <th scope="col" class="px-4 py-3">Check Type</th>
                          <th scope="col" class="px-4 py-3">Responsibility</th>
                  ...
                  @foreach($issues as $issue)
                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <div class="flex items-center">
                              <a href="{{$issue->url}}">Url</a>
                              </div>
                          </td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$issue->issue_link}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$issue->description}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              {{$issue->criterion}}
                          </td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          ...
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$issue->severity}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$issue->check_type}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$issue->responsibility}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-wrap dark:text-white "> {{$issue->issue_reference}}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$issue->date}}</td>
                      </tr>
                   @endforeach  
                  </tbody>
              </table>
